...
const htmlTaskContent = ({ id, title, description, type, url }) => `
    <div class="col-md-6 col-lg-4 mt-3"  id=${id} key=${id}>
        ...
        <button type='button' class='btn btn-outline-info mr-2' name=${id} onclick="completTask.apply(this, arguments)">
          <i class='fas fa-check' name=${id}></i>
        </button>
        ...
        <button type='button' class='btn btn-outline-danger mr-2' name=${id} onclick="deleteTask.apply(this, arguments)">
          <i class='fas fa-trash-alt' name=${id}></i>
            ...
            <div class="card-body ">
                ...
                <p class="desc trim-3-lines text-muted" data-gram_editor="false">${description}</P>
...
const htmlCompTaskContent = ({ id, title, description, type, url }) => `
<div class="col-md-6 col-lg-4 mt-3"  id=${id} key=${id}>
    <div class="card shadow-sm task__card">
    <div class='card-header d-flex gap-2 justify-content-end task__card__header'>
...
//Dynamic Modals on our homepage
...
const handleSubmit = (event) => {
  ...
  const input = {
    ...
    description: document.getElementsByName("taskdis").value,
  };
...
const hidetasktodo = () => {
  var x = document.getElementById("tasktodo");
  var y = document.getElementById("taskcompleted");
